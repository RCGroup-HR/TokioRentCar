...
import { Plus, Search, Edit, Trash2, Eye, Bike } from "lucide-react"
import { getVehicleCategoryLabel, getStatusLabel, getStatusColor } from "@/lib/utils"
...
export default function AdminMotoresPage() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm("¿Estás seguro de que deseas eliminar este motor?")) return
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Motores</h1>
          <p className="text-gray-500 dark:text-gray-400">
            Gestiona tu flota de motores
          </p>
        </div>
        <Link href="/admin/vehiculos/nuevo">
          <Button leftIcon={<Plus className="h-4 w-4" />}>Nuevo Motor</Button>
        </Link>
      </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-4">
                Agrega tu primer motor a la flota
              </p>
              <Link href="/admin/vehiculos/nuevo">
                <Button leftIcon={<Plus className="h-4 w-4" />}>Nuevo Motor</Button>
              </Link>
